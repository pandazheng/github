...
#import "UICodeAppDelegate.h"
#import "LLViewController.h"
#import "MMViewController.h"

@implementation UICodeAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [LLNav.navigationController.navigationBar setHidden:YES];
    UINavigationController *MMNav = [[UINavigationController alloc] initWithRootViewController:MMVC];
    [MMNav.navigationController.navigationBar setHidden:YES];
    
    UITabBarController *tabbarVC = [[UITabBarController alloc] init];
    tabbarVC.viewControllers = [NSArray arrayWithObjects:LLNav,MMNav, nil];
    
    //设置tabbarVC 为 window的rootViewController
